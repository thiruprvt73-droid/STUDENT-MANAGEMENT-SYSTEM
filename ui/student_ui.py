...
class StudentUI:
    ...
    def create_form(self):
        ...
        tk.Button(frame, text="Add Student",
                  command=self.add_student).grid(row=4, column=0)

        tk.Button(frame, text="Delete Student",
                  command=self.delete_student).grid(row=4, column=1)

        tk.Button(frame, text="Update Student",
                  command=self.update_student).grid(row=4, column=2)
        ...
        tk.Button(frame, text="Search",
                  command=self.search_student_ui).grid(row=5, column=2)

        tk.Button(frame, text="List Students",
                  command=self.load_students).grid(row=6, column=1)
    ...
    def create_table(self):
        ...
        self.tree.column("Dept", width=180)
